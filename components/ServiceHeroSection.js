        ...
        >
          ...
          >
            <Link
              ...
              className="block w-full sm:w-auto px-6 py-3 text-base sm:text-lg font-sans font-semibold text-white bg-[#06B6D4] rounded-2xl shadow-md hover:bg-cyan-500 transition-colors text-center"
            >
          ...
          >
            <Link
              href="#"
              className="block w-full sm:w-auto px-6 py-3 text-base sm:text-lg font-sans font-semibold text-white border border-gray-500 rounded-2xl hover:bg-white/10 transition-colors text-center"
            >
