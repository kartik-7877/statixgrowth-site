...
export default function HeroSection() {
  ...
  return (
    <section className="relative w-full min-h-[78vh] md:min-h-0 md:h-screen flex items-center justify-center overflow-hidden pt-14 pb-12 sm:pt-16 sm:pb-14 md:py-0">
      {/* Background Canvas */}
